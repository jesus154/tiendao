    ...
    <body>
        ...
        <aside class="sidebar position-fixed top-0 left-0 overflow-auto h-100 float-left" id="show-side-navigation1">
            ...
            <li class="has-dropdown">
                ...
                <ul class="sidebar-dropdown list-unstyled">
                    <li><button onclick="openProductos()">Productos</button></li>
                    <li><button onclick="insertarProductos()">Insertar</button></li>
                </ul>
            </li>
            <li class="has-dropdown">
        ...
        <script>
            ...
            function openProductos() {
                window.open("Productos/productos.php", "Productos", "width=600,height=400,scrollbars=yes");
            }
            function insertarProductos() {
                window.open("Productos/insertar.php", "Productos", "width=600,height=400,scrollbars=yes");
            }
